  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'dark-tremor': {
          brand: {
            faint: greenShades.lighter,
            muted: greenShades.DEFAULT,
            subtle: goldShades.dark,
            DEFAULT: greenShades.DEFAULT,
            emphasis: goldShades.DEFAULT,
            inverted: colors.violet[500],
          },
          background: {
            muted: greenShades.darker,
