import { Card, Color, Title } from '@tremor/react'
import { ReactNode } from 'react'
import { QueryStatus } from '@/lib/tracking/types'
...
function WidgetContent({
  ...
  return (
    <div className={cn(className, 'mt-1 h-full')}>
      {status === 'loading' ? (
...
export const tremorPieChartColors: [Color, string][] = [
  ['yellow', tremorColors.yellow],
  ['green', tremorColors.green],
  ['orange', tremorColors.orange],
  ['stone', tremorColors.stone],
