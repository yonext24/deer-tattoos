...
export default async function Page() {
  ...
  return (
    <Section className="min-h-[auto] flex w-full my-4">
      <div className="grid grid-cols-[40%,60%] w-full max-[850px]:flex max-[850px]:flex-col">
        <div className="flex flex-col">
          ...
          <div className="relative max-[850px]:w-max max-[850px]:mx-auto after:top-0 after:left-0 after:absolute after:z-10 after:w-full after:h-full after:[background:_radial-gradient(circle,_rgba(10,10,10,0)_0%,_rgba(0,0,0,1)_100%)]">
            <Image
              src="/local.webp"
